...
elaborate RISC_V -architecture rtl -library WORK > ./logs/RISC_V_v2/elaborate_v2.txt
...
report_timing -nworst 10 > ./reports/RISC_V_v2/timing_v2.txt
...
write -f verilog -hierarchy -output ./reports/RISC_V_v1/netlist/RISC_V_v2.v
