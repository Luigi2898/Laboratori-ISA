...
compile
#report_timing > ./MBE_WALLACE_reports/per10_wall.txt
#optimize_registers
#report_timing > ./MBE_WALLACE_reports/maxper_optwall.txt
#create_clock -name MY_CLK -period 10 clk
#report_timing  > ./MBE_WALLACE_reports/opt_wallace_timing.txt
#report_area > ./MBE_WALLACE_reports/opt_wallace_area.txt  
#compile_ultra -retime
#report_timing > ./MBE_WALLACE_reports/maxper_ultrambe.txt
#create_clock -name MY_CLK -period 10 clk
#report_timing  > ./MBE_WALLACE_reports/ultra_mbe_timing.txt
#report_area > ./MBE_WALLACE_reports/ultra_mbe_area.txt  
#quit
