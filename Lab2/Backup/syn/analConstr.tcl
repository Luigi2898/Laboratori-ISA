...
compile
report_timing > ./Fine_grain_reports/maxper_preopt.txt
optimize_registers
report_timing > ./Fine_grain_reports/maxper_opt.txt
create_clock -name MY_CLK -period 10 clk
report_timing > ./Fine_grain_reports/optreg_timing.txt
report_area > ./Fine_grain_reports/optreg_area.txt  
quit
