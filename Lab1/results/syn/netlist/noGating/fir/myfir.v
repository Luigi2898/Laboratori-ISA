...
module MYFIR ( RST_N, CLK, VIN, DIN, H0, H1, H2, H3, H4, H5, H6, H7, H8, DOUT, 
  ...
  NAND2_X1 DP_output_register_U19 ( .A1(DP_sum[6]), .A2(DP_output_register_n34), .ZN(DP_output_register_n10) );
  OAI21_X1 DP_output_register_U18 ( .B1(DP_output_register_n21), .B2(
        DP_output_register_n35), .A(DP_output_register_n10), .ZN(
        DP_output_register_n32) );
  NAND2_X1 DP_output_register_U17 ( .A1(DP_sum[5]), .A2(DP_output_register_n34), .ZN(DP_output_register_n9) );
  OAI21_X1 DP_output_register_U16 ( .B1(DP_output_register_n20), .B2(
        DP_output_register_n35), .A(DP_output_register_n9), .ZN(
        DP_output_register_n31) );
  NAND2_X1 DP_output_register_U15 ( .A1(DP_sum[4]), .A2(DP_output_register_n34), .ZN(DP_output_register_n8) );
  OAI21_X1 DP_output_register_U14 ( .B1(DP_output_register_n19), .B2(
        DP_output_register_n35), .A(DP_output_register_n8), .ZN(
        DP_output_register_n30) );
  NAND2_X1 DP_output_register_U13 ( .A1(DP_sum[3]), .A2(DP_output_register_n34), .ZN(DP_output_register_n7) );
  OAI21_X1 DP_output_register_U12 ( .B1(DP_output_register_n18), .B2(
        DP_output_register_n35), .A(DP_output_register_n7), .ZN(
        DP_output_register_n29) );
  NAND2_X1 DP_output_register_U11 ( .A1(DP_sum[2]), .A2(DP_output_register_n34), .ZN(DP_output_register_n6) );
  OAI21_X1 DP_output_register_U10 ( .B1(DP_output_register_n17), .B2(
        DP_output_register_n35), .A(DP_output_register_n6), .ZN(
        DP_output_register_n28) );
  NAND2_X1 DP_output_register_U9 ( .A1(DP_sum[1]), .A2(DP_output_register_n34), 
        .ZN(DP_output_register_n5) );
  OAI21_X1 DP_output_register_U8 ( .B1(DP_output_register_n16), .B2(
        DP_output_register_n35), .A(DP_output_register_n5), .ZN(
        DP_output_register_n27) );
  NAND2_X1 DP_output_register_U7 ( .A1(DP_sum[7]), .A2(DP_output_register_n34), 
        .ZN(DP_output_register_n11) );
  OAI21_X1 DP_output_register_U6 ( .B1(DP_output_register_n22), .B2(
        DP_output_register_n34), .A(DP_output_register_n11), .ZN(
        DP_output_register_n33) );
  NAND2_X1 DP_output_register_U5 ( .A1(DP_sum[0]), .A2(DP_output_register_n34), 
        .ZN(DP_output_register_n4) );
  OAI21_X1 DP_output_register_U4 ( .B1(DP_output_register_n15), .B2(
  ...
  INV_X1 DP_mult_77_G5_U174 ( .A(H4[6]), .ZN(DP_mult_77_G5_n214) );
