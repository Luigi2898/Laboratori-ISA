...
set clock uncertainty 0.07 [get clocks MY CLK]
set input delay 0.5 -max -clock MY CLK [remove from collection [all inputs] CLK]
set output delay 0.5 -max -clock MY CLK [all outputs]
