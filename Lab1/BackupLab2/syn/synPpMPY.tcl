...
compile -exact_map
report_resources
report_timing -nworst 10 > ./synthReport/report_timing_pparch.txt
report_area > ./synthReport/report_area_pparch.txt
report_resources > ./synthReport/report_resources_pparch.txt
report_synlib dw_foundation.sldb > ./synthReport/report_synthetic_library.txt
