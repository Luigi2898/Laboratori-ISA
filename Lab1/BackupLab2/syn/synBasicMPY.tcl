...
compile -exact_map
report_timing -nworst 10 > ./synthReport/report_timing_standard.txt
report_area > ./synthReport/report_area_standard.txt
report_resources > ./synthReport/report_resources_standard.txt
quit
